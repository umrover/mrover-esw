...
if __name__ == "__main__":
    ...
    with CANBus(get_dbc(dbc_name="CANBus1"), "can0", on_recv=on_msg_recv) as bus:
        ...
        bus.send("BMCConfigCmd", {"address": 0x00, "value": 0x05, "apply": 0x0}, node_id=0)
        bus.send("BMCConfigCmd", {"address": 0x00, "value": 0x05, "apply": 0x0}, node_id=5)
        # sleep(5)
        # bus.send("BMCConfigCmd", {"address": 0x00, "value": 0x05, "apply": 0x1}, node_id=0)
        # sleep(5)
