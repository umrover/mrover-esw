        ...
        switch (index) {
            case 0:
                return Motor(
                        ...
                        HBridge{PWM_TIMER_0, PWM_TIMER_CHANNEL_0, Pin{MOTOR_DIR_GPIO_Port, MOTOR_DIR_Pin}, Pin{MOTOR_DIR_1_GPIO_Port, MOTOR_DIR_1_Pin}},
#else
                        HBridge{PWM_TIMER_0, PWM_TIMER_CHANNEL_0, Pin{MOTOR_DIR_GPIO_Port, MOTOR_DIR_Pin}},
#endif
                        RECEIVE_WATCHDOG_TIMER_0,
                        {LimitSwitch{Pin{LIMIT_A_GPIO_Port, LIMIT_A_Pin}}, LimitSwitch{Pin{LIMIT_B_GPIO_Port, LIMIT_B_Pin}}},
