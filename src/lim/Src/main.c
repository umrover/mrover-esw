...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SPI_CS_Pin|PGOOD_Pin|CAN_RX_LED_Pin|CAN_TX_LED_Pin
                          |MOTOR_DIR_Pin|CAN_STB_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_CS_Pin PGOOD_Pin CAN_RX_LED_Pin CAN_TX_LED_Pin
                           MOTOR_DIR_Pin CAN_STB_Pin */
  GPIO_InitStruct.Pin = SPI_CS_Pin|PGOOD_Pin|CAN_RX_LED_Pin|CAN_TX_LED_Pin
                          |MOTOR_DIR_Pin|CAN_STB_Pin;
